//
//  METTrendHostController.swift
//  BackgammonGym
//
//  Hosts the shared SwiftUI PipTrendChart for the MET module. Identical in
//  behaviour to PipTrendHostController, but pulls its data from
//  metSessionChartData(forMode:) so it charts MET sessions. The chart view
//  itself is module-neutral and reused as-is.
//
...
@objc public class METTrendHostController: UIViewController {
    ...
    private func makeChart() -> PipTrendChart {
        let data = CoreDataManager.shared().metSessionChartData(forMode: modeFilter)
